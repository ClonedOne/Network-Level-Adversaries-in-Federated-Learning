...
from  nlafl import emnist_sample
from nlafl.emnist_models import FLServer
from nlafl.emnist_models import FederatedClient
...
if __name__ == '__main__':
    ...
    # generate clients
    trn_x, trn_y, tst_x, tst_y = emnist_sample.load_emnist()
    partitioned = emnist_sample.partition(trn_x, trn_y)
    tst_partitioned = emnist_sample.partition(tst_x, tst_y)
    ...
    if args.poison_count > 0:
        client_data = emnist_sample.fixed_poison(
            partitioned,
            NUM_USERS,
            CLIENT_SIZE,
            args.poison_count,
        ...
        client_data = emnist_sample.fixed_sample(
            partitioned,
            NUM_USERS,
            CLIENT_SIZE,
            targ_class=args.target_class,
